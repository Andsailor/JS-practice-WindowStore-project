...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_timer__WEBPACK_IMPORTED_MODULE_5__["default"])(2022, 9, 31);
...
var forms = function forms(state) {
  ...
  integersOnly.forEach(function (item) {
    ...
    return regeneratorRuntime.async(function postData$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            document.querySelector('.status').innerHTML = "<img src=".concat(message.loading, " alt=\"spinner\">");
            _context.next = 3;
...
var modal = function modal() {
  function modalWindow(selector, trigger, closeTrigger) {
...
var tabs = function tabs() {
  function tabsStatusChange(tabSelector, tabContentSelector, activeClass, display, tabContentImg) {
    var trigger = document.querySelectorAll(tabSelector),
    ...
    tabImgTrigger.forEach(function (item, i) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
var timer = function timer(year, month, dayDate) {
  ...
  function setTimer() {
    ...
    var deadline = Date.parse(new Date(year, month, dayDate));
    var ms = deadline - date;
    var day = Math.floor(ms / (1000 * 60 * 60 * 24) % 30);
    var hour = Math.floor(ms / (1000 * 60 * 60) % 24);
    var minute = Math.floor(ms / (1000 * 60) % 60);
    var second = Math.round(ms / 1000 % 60);
  ...
  var timeout = setInterval(setTimer, 1000);
};
